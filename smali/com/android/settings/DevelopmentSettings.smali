...
.field private mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;
...
.field private mTransitionAnimationScale:Lcom/android/settings/AnimationScalePreference;
...
.field private mWindowAnimationScale:Lcom/android/settings/AnimationScalePreference;
...
.method private findAndInitAnimationScalePreference(Ljava/lang/String;)Lcom/android/settings/AnimationScalePreference;
    .locals 2
    .parameter "key"
    ...
    check-cast v0, Lcom/android/settings/AnimationScalePreference;

    .line 414
    .local v0, pref:Lcom/android/settings/AnimationScalePreference;
    invoke-virtual {v0, p0}, Lcom/android/settings/AnimationScalePreference;->setOnPreferenceChangeListener(Landroid/preference/Preference$OnPreferenceChangeListener;)V

    .line 415
    invoke-virtual {v0, p0}, Lcom/android/settings/AnimationScalePreference;->setOnPreferenceClickListener(Landroid/preference/Preference$OnPreferenceClickListener;)V
...
.method private resetDangerousOptions()V
    ...
    .line 678
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mWindowAnimationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v5, v2, v4}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V

    .line 679
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mTransitionAnimationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v3, v2, v4}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V

    .line 680
    const/4 v2, 0x2

    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v2, v3, v4}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
...
.method private updateAdbOverNetwork()V
    ...
    .line 641
    :cond_0
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mAdbOverNetwork:Landroid/preference/CheckBoxPreference;
...
.method private updateAdvancedRebootOptions()V
    ...
    .line 616
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/CheckBoxPreference;
...
.method private updateAllOptions()V
    ...
    .line 572
    iget-object v5, p0, Lcom/android/settings/DevelopmentSettings;->mAllowMockSMS:Landroid/preference/CheckBoxPreference;
...
.method private updateAnimationScaleOptions()V
    ...
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mWindowAnimationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v0, v1}, Lcom/android/settings/DevelopmentSettings;->updateAnimationScaleValue(ILcom/android/settings/AnimationScalePreference;)V

    .line 1231
    const/4 v0, 0x1

    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mTransitionAnimationScale:Lcom/android/settings/AnimationScalePreference;
    ...
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;
...
.method private updateAnimationScaleValue(ILcom/android/settings/AnimationScalePreference;)V
    .locals 2
    .parameter "which"
    .parameter "pref"
    ...
    .line 1224
    :cond_0
    invoke-virtual {p2, v0}, Lcom/android/settings/AnimationScalePreference;->setScale(F)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private updateDevelopmentShortcutOptions()V
    ...
    .line 632
    iget-object v1, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/CheckBoxPreference;
...
.method private updateUpdateRecoveryOptions()V
    ...
    .prologue
    .line 1336
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/CheckBoxPreference;
...
.method private writeAdvancedRebootOptions()V
    ...
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/CheckBoxPreference;
...
.method private writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    .locals 2
    .parameter "which"
    .parameter "pref"
    .parameter "newValue"
    ...
    .line 1240
    invoke-direct {p0, p1, p2}, Lcom/android/settings/DevelopmentSettings;->updateAnimationScaleValue(ILcom/android/settings/AnimationScalePreference;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method private writeDevelopmentShortcutOptions()V
    ...
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/CheckBoxPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdbNotify:Landroid/preference/CheckBoxPreference;
    ...
    invoke-static {v3, v4}, Lcom/android/settings/Utils;->isPackageInstalled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdbOverNetwork:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAllowMockSMS:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/CheckBoxPreference;
    ...
    .line 318
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAdvancedReboot:Landroid/preference/CheckBoxPreference;

    invoke-direct {p0, v3}, Lcom/android/settings/DevelopmentSettings;->disableForUser(Landroid/preference/Preference;)V

    .line 319
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mUpdateRecovery:Landroid/preference/CheckBoxPreference;

    invoke-direct {p0, v3}, Lcom/android/settings/DevelopmentSettings;->disableForUser(Landroid/preference/Preference;)V

    .line 320
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentShortcut:Landroid/preference/CheckBoxPreference;
    ...
    invoke-direct {p0, v3}, Lcom/android/settings/DevelopmentSettings;->findAndInitAnimationScalePreference(Ljava/lang/String;)Lcom/android/settings/AnimationScalePreference;

    move-result-object v3

    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mWindowAnimationScale:Lcom/android/settings/AnimationScalePreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mTransitionAnimationScale:Lcom/android/settings/AnimationScalePreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mRootAccess:Landroid/preference/ListPreference;
    ...
    iput-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentTools:Landroid/preference/PreferenceScreen;

    .line 395
    iget-object v3, p0, Lcom/android/settings/DevelopmentSettings;->mAllPrefs:Ljava/util/ArrayList;

    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mDevelopmentTools:Landroid/preference/PreferenceScreen;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v0, v2, p2}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    ...
    .line 1585
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mTransitionAnimationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v1, v0, p2}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    ...
    .line 1587
    :cond_6
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;

    if-ne p1, v2, :cond_7

    .line 1588
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mAnimatorDurationScale:Lcom/android/settings/AnimationScalePreference;

    invoke-direct {p0, v8, v0, p2}, Lcom/android/settings/DevelopmentSettings;->writeAnimationScaleOption(ILcom/android/settings/AnimationScalePreference;Ljava/lang/Object;)V
    ...
    iput-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mRootDialog:Landroid/app/Dialog;
...
.method public onPreferenceClick(Landroid/preference/Preference;)Z
    ...
    .prologue
    .line 1393
    iget-object v0, p0, Lcom/android/settings/DevelopmentSettings;->mWindowAnimationScale:Lcom/android/settings/AnimationScalePreference;
    ...
    .line 1396
    :cond_0
    check-cast p1, Lcom/android/settings/AnimationScalePreference;

    .end local p1
    invoke-virtual {p1}, Lcom/android/settings/AnimationScalePreference;->click()V
...
.method public onPreferenceTreeClick(Landroid/preference/PreferenceScreen;Landroid/preference/Preference;)Z
    ...
    .line 1477
    :cond_13
    iget-object v2, p0, Lcom/android/settings/DevelopmentSettings;->mAllowMockSMS:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v4, p0, Lcom/android/settings/DevelopmentSettings;->mAllowMockSMS:Landroid/preference/CheckBoxPreference;
