...
.method buildHomeActivitiesList()V
    ...
    invoke-direct/range {v1 .. v10}, Lcom/android/settings/HomeSettings$HomeAppPreference;-><init>(Lcom/android/settings/HomeSettings;Landroid/content/Context;Landroid/content/ComponentName;ILandroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Lcom/android/settings/HomeSettings;Landroid/content/pm/ActivityInfo;Landroid/content/Intent;)V
...
.method public onActivityResult(IILandroid/content/Intent;)V
    ...
    .line 128
    iget-object v4, p0, Lcom/android/settings/HomeSettings;->mCurrentHome:Lcom/android/settings/HomeSettings$HomeAppPreference;
    ...
    .local v1, i:I
    :goto_0
    iget-object v4, p0, Lcom/android/settings/HomeSettings;->mPrefs:Ljava/util/ArrayList;
    ...
    check-cast v3, Lcom/android/settings/HomeSettings$HomeAppPreference;

    .line 131
    .local v3, pref:Lcom/android/settings/HomeSettings$HomeAppPreference;
    iget-boolean v4, v3, Lcom/android/settings/HomeSettings$HomeAppPreference;->isSystem:Z

    if-eqz v4, :cond_5

    .line 132
    invoke-virtual {p0, v3}, Lcom/android/settings/HomeSettings;->makeCurrentHome(Lcom/android/settings/HomeSettings$HomeAppPreference;)V

    .line 139
    .end local v1           #i:I
    .end local v3           #pref:Lcom/android/settings/HomeSettings$HomeAppPreference;
    :cond_0
    const/4 v0, 0x0
    ...
    .line 141
    .restart local v3       #pref:Lcom/android/settings/HomeSettings$HomeAppPreference;
    iget-object v4, v3, Lcom/android/settings/HomeSettings$HomeAppPreference;->prefsIntent:Landroid/content/Intent;
    ...
    .line 151
    iget-boolean v4, p0, Lcom/android/settings/HomeSettings;->mShowNotice:Z
    ...
    iput-boolean v4, p0, Lcom/android/settings/HomeSettings;->mShowNotice:Z
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 225
    invoke-virtual {p0, v2}, Lcom/android/settings/HomeSettings;->setHasOptionsMenu(Z)V
...
.method public onCreateOptionsMenu(Landroid/view/Menu;Landroid/view/MenuInflater;)V
    ...
    .line 238
    .local v2, selectedPref:Lcom/android/settings/HomeSettings$HomeAppPreference;
    iget-object v3, p0, Lcom/android/settings/HomeSettings;->mPrefs:Ljava/util/ArrayList;
    ...
    .line 239
    .local v1, pref:Lcom/android/settings/HomeSettings$HomeAppPreference;
    iget-boolean v3, v1, Lcom/android/settings/HomeSettings$HomeAppPreference;->isChecked:Z
    ...
    iget-object v3, v2, Lcom/android/settings/HomeSettings$HomeAppPreference;->prefsIntent:Landroid/content/Intent;
    ...
    iget-object v4, v2, Lcom/android/settings/HomeSettings$HomeAppPreference;->prefsIntent:Landroid/content/Intent;
