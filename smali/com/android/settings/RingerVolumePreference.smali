...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/RingerVolumePreference;->setDialogTitle(Ljava/lang/CharSequence;)V
...
.method static synthetic access$300(Lcom/android/settings/RingerVolumePreference;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 59
    iget-boolean v0, p0, Lcom/android/settings/RingerVolumePreference;->mDialogClicked:Z

    return v0
.end method

.method static synthetic access$302(Lcom/android/settings/RingerVolumePreference;Z)Z
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 59
    iput-boolean p1, p0, Lcom/android/settings/RingerVolumePreference;->mDialogClicked:Z

    return p1
.end method

.method static synthetic access$400(Lcom/android/settings/RingerVolumePreference;)Landroid/app/Dialog;
    .locals 1
    .parameter "x0"

    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/RingerVolumePreference;->mWaiverDialog:Landroid/app/Dialog;

    return-object v0
.end method

.method static synthetic access$402(Lcom/android/settings/RingerVolumePreference;Landroid/app/Dialog;)Landroid/app/Dialog;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 59
    iput-object p1, p0, Lcom/android/settings/RingerVolumePreference;->mWaiverDialog:Landroid/app/Dialog;

    return-object p1
.end method

.method static synthetic access$500(Lcom/android/settings/RingerVolumePreference;)V
    .locals 0
    .parameter "x0"

    .prologue
    .line 59
    invoke-direct {p0}, Lcom/android/settings/RingerVolumePreference;->dismissDialog()V

    return-void
.end method

.method static synthetic access$600(Lcom/android/settings/RingerVolumePreference;)Landroid/widget/CheckBox;
    .locals 1
    .parameter "x0"

    .prologue
    .line 59
    iget-object v0, p0, Lcom/android/settings/RingerVolumePreference;->mSafeHeadsetVolume:Landroid/widget/CheckBox;

    return-object v0
.end method

.method static synthetic access$700(Lcom/android/settings/RingerVolumePreference;)Landroid/os/Handler;
    .locals 1
    .parameter "x0"
...
.method private dismissDialog()V
    ...
    iput-object v0, p0, Lcom/android/settings/RingerVolumePreference;->mWaiverDialog:Landroid/app/Dialog;
...
.method protected onBindDialogView(Landroid/view/View;)V
    ...
    iput-object v1, v0, Lcom/android/settings/RingerVolumePreference;->mSafeHeadsetVolume:Landroid/widget/CheckBox;
    ...
    invoke-direct {v1, v0, v14, v15, v12}, Lcom/android/settings/RingerVolumePreference$3;-><init>(Lcom/android/settings/RingerVolumePreference;Landroid/view/View;Landroid/widget/TextView;Landroid/widget/CheckBox;)V
    ...
    iget-object v2, v0, Lcom/android/settings/RingerVolumePreference;->mSafeHeadsetVolume:Landroid/widget/CheckBox;
    ...
    iget-object v1, v0, Lcom/android/settings/RingerVolumePreference;->mSafeHeadsetVolume:Landroid/widget/CheckBox;

    new-instance v2, Lcom/android/settings/RingerVolumePreference$5;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Lcom/android/settings/RingerVolumePreference$5;-><init>(Lcom/android/settings/RingerVolumePreference;)V
    ...
    .line 374
    new-instance v1, Lcom/android/settings/RingerVolumePreference$6;

    move-object/from16 v0, p0

    invoke-direct {v1, v0}, Lcom/android/settings/RingerVolumePreference$6;-><init>(Lcom/android/settings/RingerVolumePreference;)V
