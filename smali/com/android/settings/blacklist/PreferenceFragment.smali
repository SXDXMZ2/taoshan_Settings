.class public Lcom/android/settings/blacklist/PreferenceFragment;
...
.method private updatePolicyFromSelectList(Ljava/util/Set;Ljava/lang/String;)V
    ...
    .line 120
    .local p1, values:Ljava/util/Set;,"Ljava/util/Set<Ljava/lang/String;>;"
    invoke-direct {p0, p1}, Lcom/android/settings/blacklist/PreferenceFragment;->getPolicyFromSelectList(Ljava/util/Set;)I

    move-result v0

    .line 121
    .local v0, mode:I
    invoke-virtual {p0}, Lcom/android/settings/blacklist/PreferenceFragment;->getContentResolver()Landroid/content/ContentResolver;
...
.method private updateSelectListSummary(Landroid/preference/MultiSelectListPreference;Ljava/util/Set;II)V
    ...
    .line 126
    invoke-direct {p0, p2}, Lcom/android/settings/blacklist/PreferenceFragment;->getPolicyFromSelectList(Ljava/util/Set;)I
    ...
    .line 130
    invoke-virtual {p0, p4}, Lcom/android/settings/blacklist/PreferenceFragment;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/blacklist/PreferenceFragment;->getString(I)Ljava/lang/String;

    move-result-object v4

    aput-object v4, v2, v3

    invoke-virtual {p0, p3, v2}, Lcom/android/settings/blacklist/PreferenceFragment;->getString(I[Ljava/lang/Object;)Ljava/lang/String;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v1}, Lcom/android/settings/blacklist/PreferenceFragment;->addPreferencesFromResource(I)V

    .line 49
    invoke-virtual {p0}, Lcom/android/settings/blacklist/PreferenceFragment;->getPreferenceScreen()Landroid/preference/PreferenceScreen;
    ...
    iput-object v1, p0, Lcom/android/settings/blacklist/PreferenceFragment;->mBlacklistPrivate:Landroid/preference/MultiSelectListPreference;
    ...
    iput-object v1, p0, Lcom/android/settings/blacklist/PreferenceFragment;->mBlacklistUnknown:Landroid/preference/MultiSelectListPreference;
...
.method public onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/settings/blacklist/PreferenceFragment;->updatePolicyFromSelectList(Ljava/util/Set;Ljava/lang/String;)V
...
.method public onResume()V
    ...
    .line 62
    invoke-virtual {p0}, Lcom/android/settings/blacklist/PreferenceFragment;->getActivity()Landroid/app/Activity;
    ...
    invoke-direct {p0, v1, v2}, Lcom/android/settings/blacklist/PreferenceFragment;->updateSelectListFromPolicy(Landroid/preference/MultiSelectListPreference;Ljava/lang/String;)V

    .line 65
    iget-object v1, p0, Lcom/android/settings/blacklist/PreferenceFragment;->mBlacklistPrivate:Landroid/preference/MultiSelectListPreference;

    iget-object v2, p0, Lcom/android/settings/blacklist/PreferenceFragment;->mBlacklistPrivate:Landroid/preference/MultiSelectListPreference;
    ...
    iget-object v2, p0, Lcom/android/settings/blacklist/PreferenceFragment;->mBlacklistUnknown:Landroid/preference/MultiSelectListPreference;
