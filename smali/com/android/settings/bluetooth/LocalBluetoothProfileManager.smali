...
.method declared-synchronized updateProfiles([Landroid/os/ParcelUuid;[Landroid/os/ParcelUuid;Ljava/util/Collection;Ljava/util/Collection;ZLandroid/bluetooth/BluetoothDevice;)V
    ...
    .line 370
    :cond_4
    const-string v0, "bluetooth.a2dp.sink.enabled"
    ...
    const-string v1, "a2dpSinkSupported, check for both sink and source UUIDs"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 372
    sget-object v0, Lcom/android/settings/bluetooth/A2dpProfile;->SOURCE_UUIDS:[Landroid/os/ParcelUuid;
    ...
    const-string v1, "a2dpSinkNotSupported, check for only sink UUIDs"
