...
.method private updateUnlockButtonTypes()V
    ...
    invoke-virtual {p0}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->getActivity()Landroid/app/Activity;
    ...
    invoke-static {v7, v3}, Lcom/android/settings/Utils;->getApplicationMetadata(Landroid/content/Context;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    .line 171
    iget-object v7, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mHomeUnlock:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v7, v6}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 172
    iget-object v7, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mCameraUnlock:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v7, v6}, Landroid/preference/CheckBoxPreference;->setEnabled(Z)V

    .line 173
    iget-object v7, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mMenuUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mHomeUnlock:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v6, v2}, Landroid/preference/CheckBoxPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 177
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mCameraUnlock:Landroid/preference/CheckBoxPreference;

    invoke-virtual {v6, v2}, Landroid/preference/CheckBoxPreference;->setSummary(Ljava/lang/CharSequence;)V

    .line 178
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mMenuUnlock:Landroid/preference/CheckBoxPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->addPreferencesFromResource(I)V
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mMenuUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mHomeUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mCameraUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v0, v0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mCameraUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mLongBackAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mLongHomeAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mLongMenuAction:Landroid/preference/ListPreference;
    ...
    iput-object v0, v1, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mActions:[Landroid/preference/ListPreference;

    .line 119
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mActions:[Landroid/preference/ListPreference;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->getActivity()Landroid/app/Activity;
    ...
    iget-object v0, v0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mHomeUnlock:Landroid/preference/CheckBoxPreference;
    ...
    iget-object v0, v0, Lcom/android/settings/cyanogenmod/LockscreenButtons;->mMenuUnlock:Landroid/preference/CheckBoxPreference;
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->getString(I)Ljava/lang/String;
...
.method public onResume()V
    ...
    :cond_0
    invoke-direct {p0}, Lcom/android/settings/cyanogenmod/LockscreenButtons;->updateUnlockButtonTypes()V
