.class Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/android/settings/cyanogenmod/LtoService;
.end annotation
...
.field final synthetic this$0:Lcom/android/settings/cyanogenmod/LtoService;


# direct methods
.method public constructor <init>(Lcom/android/settings/cyanogenmod/LtoService;Ljava/lang/String;Ljava/io/File;)V
    .locals 5
    .parameter
    .parameter "source"
    ...
    .prologue
    .line 154
    iput-object p1, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->this$0:Lcom/android/settings/cyanogenmod/LtoService;

    invoke-direct {p0}, Landroid/os/AsyncTask;-><init>()V

    .line 155
    iput-object p2, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mSource:Ljava/lang/String;

    .line 156
    iput-object p3, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mDestination:Ljava/io/File;
    ...
    invoke-virtual {p1}, Lcom/android/settings/cyanogenmod/LtoService;->getCacheDir()Ljava/io/File;
    ...
    iput-object v2, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mTempFile:Ljava/io/File;
    :try_end_0
    ...
    invoke-virtual {p1, v2}, Lcom/android/settings/cyanogenmod/LtoService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method private finish(I)V
    ...
    .line 254
    iget-object v0, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->this$0:Lcom/android/settings/cyanogenmod/LtoService;

    .line 256
    .local v0, context:Landroid/content/Context;
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mTempFile:Ljava/io/File;
    ...
    .line 258
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mDestination:Ljava/io/File;
    ...
    iget-object v7, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mDestination:Ljava/io/File;
    ...
    .line 278
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->this$0:Lcom/android/settings/cyanogenmod/LtoService;

    #calls: Lcom/android/settings/cyanogenmod/LtoService;->scheduleNextDownload(J)Landroid/app/PendingIntent;
    invoke-static {v6, v4, v5}, Lcom/android/settings/cyanogenmod/LtoService;->access$000(Lcom/android/settings/cyanogenmod/LtoService;J)Landroid/app/PendingIntent;

    .line 279
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->this$0:Lcom/android/settings/cyanogenmod/LtoService;

    #calls: Lcom/android/settings/cyanogenmod/LtoService;->notifyNewGpsData()V
    invoke-static {v6}, Lcom/android/settings/cyanogenmod/LtoService;->access$100(Lcom/android/settings/cyanogenmod/LtoService;)V
    ...
    :cond_1
    :goto_2
    iget-object v6, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v6}, Lcom/android/settings/cyanogenmod/LtoService;->stopSelf()V
    ...
    #calls: Lcom/android/settings/cyanogenmod/LtoService;->getLastDownload()J
    invoke-static {v6}, Lcom/android/settings/cyanogenmod/LtoService;->access$200(Lcom/android/settings/cyanogenmod/LtoService;)J
    ...
    #calls: Lcom/android/settings/cyanogenmod/LtoService;->scheduleNextDownload(J)Landroid/app/PendingIntent;
    invoke-static {v6, v2, v3}, Lcom/android/settings/cyanogenmod/LtoService;->access$000(Lcom/android/settings/cyanogenmod/LtoService;J)Landroid/app/PendingIntent;
...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Integer;
    ...
    iget-object v0, v0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mSource:Ljava/lang/String;
    ...
    iget-object v0, v0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mTempFile:Ljava/io/File;
    ...
    iget-object v14, v0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mTempFile:Ljava/io/File;
    ...
    .line 199
    invoke-virtual/range {p0 .. p0}, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->isCancelled()Z
    ...
    iget-object v14, v0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mDestination:Ljava/io/File;
    :try_end_4
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->publishProgress([Ljava/lang/Object;)V
    :try_end_5
...
.method protected bridge synthetic doInBackground([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local p1
    invoke-virtual {p0, p1}, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->doInBackground([Ljava/lang/Void;)Ljava/lang/Integer;
...
.method protected onCancelled()V
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->finish(I)V
...
.method protected bridge synthetic onPostExecute(Ljava/lang/Object;)V
    ...
    .end local p1
    invoke-virtual {p0, p1}, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->onPostExecute(Ljava/lang/Integer;)V
...
.method protected onPreExecute()V
    ...
    .prologue
    .line 169
    iget-object v0, p0, Lcom/android/settings/cyanogenmod/LtoService$LtoDownloadTask;->mWakeLock:Landroid/os/PowerManager$WakeLock;
