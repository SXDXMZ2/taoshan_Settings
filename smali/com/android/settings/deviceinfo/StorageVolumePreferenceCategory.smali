...
.implements Lcom/android/settings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;
...
.method private constructor <init>(Landroid/content/Context;Landroid/os/storage/StorageVolume;)V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    :cond_0
    iput-boolean v1, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
...
.method static synthetic access$100(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;)Lcom/android/settings/deviceinfo/UsageBarPreference;
    .locals 1
    .parameter "x0"
...
.method public init()V
    ...
    invoke-direct {v0, v10}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->getUsersExcluding(Landroid/content/pm/UserInfo;)Ljava/util/List;
    ...
    iget-boolean v0, v0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    iget-boolean v0, v0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
    ...
    invoke-virtual {v0, v1}, Lcom/android/settings/deviceinfo/UsageBarPreference;->setOnRequestMediaRescanListener(Lcom/android/settings/deviceinfo/UsageBarPreference$OnRequestMediaRescanListener;)V
    ...
    invoke-virtual {v0, v5}, Lcom/android/settings/deviceinfo/UsageBarPreference;->setAllowMediaScan(Z)V
...
.method public onRequestMediaRescan()V
    ...
    iget-boolean v3, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsInternal:Z
    ...
    :cond_0
    iget-boolean v3, p0, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;->mIsPrimary:Z
...
.method public onScanCompleted(Ljava/lang/String;Landroid/net/Uri;)V
    ...
    new-instance v1, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory$3;

    invoke-direct {v1, p0, p2}, Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory$3;-><init>(Lcom/android/settings/deviceinfo/StorageVolumePreferenceCategory;Landroid/net/Uri;)V
