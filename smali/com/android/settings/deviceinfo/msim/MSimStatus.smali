...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, Lcom/android/settings/deviceinfo/msim/MSimStatus$MyHandler;-><init>(Lcom/android/settings/deviceinfo/msim/MSimStatus;)V
    ...
    invoke-virtual {p0, v0}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/telephony/MSimTelephonyManager;

    iput-object v0, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;
    ...
    iput v0, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mNumPhones:I

    .line 151
    iget v0, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mNumPhones:I

    new-array v0, v0, [Landroid/telephony/PhoneStateListener;

    iput-object v0, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mPhoneStateListener:[Landroid/telephony/PhoneStateListener;

    move v0, v1

    .line 153
    :goto_0
    iget v2, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mNumPhones:I
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getPhoneStateListener(I)Landroid/telephony/PhoneStateListener;
    ...
    .line 155
    iget-object v2, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;

    iget-object v3, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mPhoneStateListener:[Landroid/telephony/PhoneStateListener;
    ...
    invoke-virtual {p0}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getPackageName()Ljava/lang/String;
    ...
    const-class v3, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->mRes:Landroid/content/res/Resources;

    .line 171
    sget-object v0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->sUnknown:Ljava/lang/String;
    ...
    sput-object v0, Lcom/android/settings/deviceinfo/msim/MSimStatus;->sUnknown:Ljava/lang/String;
    ...
    .line 179
    invoke-direct {p0, v3}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->removePreferenceFromScreen(Ljava/lang/String;)V
    ...
    .line 188
    invoke-direct {p0}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->getSerialNumber()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/android/settings/deviceinfo/msim/MSimStatus;->removePreferenceFromScreen(Ljava/lang/String;)V
