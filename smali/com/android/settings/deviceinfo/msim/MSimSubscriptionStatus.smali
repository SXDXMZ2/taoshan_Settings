...
.method public constructor <init>()V
    ...
    .line 113
    iput v1, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSub:I

    .line 114
    iput v1, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mDataState:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v6}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Landroid/telephony/MSimTelephonyManager;

    iput-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;

    .line 145
    const v6, 0x7f050019

    invoke-virtual {p0, v6}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->addPreferencesFromResource(I)V
    ...
    iput v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSub:I
    ...
    iget v8, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSub:I
    ...
    .line 151
    iget v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSub:I

    invoke-direct {p0, v6}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->getPhoneStateListener(I)Landroid/telephony/PhoneStateListener;

    move-result-object v6

    iput-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mPhoneStateListener:Landroid/telephony/PhoneStateListener;

    .line 152
    iget-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;

    iget-object v7, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mPhoneStateListener:Landroid/telephony/PhoneStateListener;
    ...
    iput-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mRes:Landroid/content/res/Resources;

    .line 157
    sget-object v6, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->sUnknown:Ljava/lang/String;

    if-nez v6, :cond_0

    .line 158
    iget-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mRes:Landroid/content/res/Resources;
    ...
    sput-object v6, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->sUnknown:Ljava/lang/String;
    ...
    iput-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mPhone:Lcom/android/internal/telephony/Phone;

    .line 163
    const-string v6, "signal_strength"

    invoke-virtual {p0, v6}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->findPreference(Ljava/lang/CharSequence;)Landroid/preference/Preference;

    move-result-object v6

    iput-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSigStrength:Landroid/preference/Preference;
    ...
    iget-object v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mPhone:Lcom/android/internal/telephony/Phone;
    ...
    invoke-direct {p0, v6, v7}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v6}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->removePreferenceFromScreen(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v6, v1}, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->setSummaryText(Ljava/lang/String;Ljava/lang/String;)V

    .line 227
    iget-boolean v6, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mShowLatestAreaInfo:Z
    ...
    iget-object v7, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;
    ...
    .line 215
    iput-boolean v10, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mShowLatestAreaInfo:Z
...
.method public onPause()V
    ...
    .line 262
    iget-object v0, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;
    ...
    .line 264
    :cond_0
    iget-boolean v0, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mShowLatestAreaInfo:Z
...
.method protected onResume()V
    ...
    .line 239
    iget-object v1, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mTelephonyManager:Landroid/telephony/MSimTelephonyManager;
    ...
    .line 244
    iget-boolean v1, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mShowLatestAreaInfo:Z
    ...
    iget v2, p0, Lcom/android/settings/deviceinfo/msim/MSimSubscriptionStatus;->mSub:I
